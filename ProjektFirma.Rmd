...
```
 ...
 Then we should build an app to show different plots. So we can analyse different harvest data with an app.
...
shinyApp(
      ...
      sidebarPanel(
        conditionalPanel(
          ...
          radioButtons("select1", "Choose a plot", choices = list("Average amount and profit of harvest via variety" = "case1",
                                                                  ...
                                                                  "Average days of growth via time" = "case3",
                                                                  "Average days of growth via time and variety" = "case4"
                                                                  )
          )
        ),
        conditionalPanel(
  ...
  options = list(heigh = 1000)
)
```

Or We build an interactive app where you can choose varaiables, filter and group settings.
